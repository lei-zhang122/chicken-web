...
<div class="main-container">
    <form class="form" action="" method="">
        <h2><a href="/dictionary/dictionaryPage">打卡分值管理</a> / 打卡分值维护</h2>
        <dl>
            <dt>名称：</dt>
            <dd>
            ...
            <dt>分值：</dt>
            <dd>
                <input type="text" name="dictContent" id="dictContent" maxlength="20"  value="<#if dictionary.dictContent??>${dictionary.dictContent}</#if>">
            </dd>
            <dt>排序：</dt>
            <dd>
            ...
            <dt>
                ...
                <input type="button" onclick="javascript:window.location.href='/dictionary/dictionaryPage'" class="btn" value="返回">
                &nbsp;&nbsp;
