...
<div class="main-container">
    <form class="form" action="" method="">
        <h2><a href="/dictionary/dictionaryChatPage">对话内容管理</a> / 对话内容维护</h2>
        <dl>
            <dt>标题：</dt>
            <dd>
            ...
            <dt>
                ...
                <input type="button" onclick="javascript:window.location.href='/dictionary/dictionaryChatPage'" class="btn" value="返回">
                &nbsp;&nbsp;
