...
<div class="main-container">
    ...
    <h2>对话内容列表</h2>
    <div class="query-box">
        <form class="form" name="fromSubmit" id="fromSubmit" action="/dictionary/dictionaryChatPageList" method="post">
            ...
            <input type="button" class="btn btn-success" onclick="javascript:window.location.href='/dictionary/dictionaryChatAdd/xjdh'" value="新建">
        </form>
    </div>
    <table class="table" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td><a href="/dictionary/dictionaryChatEdit/${item.id}">编辑</a></td>
        </tr>
        </#list>
        </tbody>
    </table>
